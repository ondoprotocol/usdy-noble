...
func (*QueryOwner) Descriptor() ([]byte, []int) {
	return fileDescriptor_a9bc676a503c6728, []int{0}
}
...
func (*QueryOwnerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a9bc676a503c6728, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryOwner)(nil), "ondo.usdy.blocklist.v1.QueryOwner")
	proto.RegisterType((*QueryOwnerResponse)(nil), "ondo.usdy.blocklist.v1.QueryOwnerResponse")
}

func init() {
	proto.RegisterFile("ondo/usdy/blocklist/v1/query.proto", fileDescriptor_a9bc676a503c6728)
}

var fileDescriptor_a9bc676a503c6728 = []byte{
	// 328 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0xca, 0xcf, 0x4b, 0xc9,
	...
	,
}
...
func (c *queryClient) Owner(ctx context.Context, in *QueryOwner, opts ...grpc.CallOption) (*QueryOwnerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ondo.usdy.blocklist.v1.Query/Owner", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Owner_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ondo.usdy.blocklist.v1.Query/Owner",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ondo.usdy.blocklist.v1.Query",
	...
	Metadata: "ondo/usdy/blocklist/v1/query.proto",
}
