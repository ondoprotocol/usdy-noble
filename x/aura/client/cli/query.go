...
func GetQueryCmd() *cobra.Command {
	...
	cmd.AddCommand(GetBlocklistQueryCmd())

	cmd.AddCommand(QueryDenom())
...
func QueryDenom() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			res, err := queryClient.Denom(context.Background(), &types.QueryDenom{})
			if err != nil {
				return err
			}
...
func QueryPaused() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			res, err := queryClient.Paused(context.Background(), &types.QueryPaused{})
			if err != nil {
				return err
			}
...
func QueryBurners() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "burners",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			res, err := queryClient.Burners(context.Background(), &types.QueryBurners{})
			if err != nil {
				return err
			}
...
func QueryMinters() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "minters",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			res, err := queryClient.Minters(context.Background(), &types.QueryMinters{})
			if err != nil {
				return err
			}
...
func QueryPausers() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "pausers",
