...
type ChannelAllowed struct {
	// channel is the id of the allowed channel.
	Channel string `protobuf:"bytes,1,opt,name=channel,proto3" json:"channel,omitempty"`
}

func (m *ChannelAllowed) Reset()         { *m = ChannelAllowed{} }
func (m *ChannelAllowed) String() string { return proto.CompactTextString(m) }
func (*ChannelAllowed) ProtoMessage()    {}
func (*ChannelAllowed) Descriptor() ([]byte, []int) {
	return fileDescriptor_2e649e32a11ca0c4, []int{12}
}
func (m *ChannelAllowed) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ChannelAllowed) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ChannelAllowed.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ChannelAllowed) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChannelAllowed.Merge(m, src)
}
func (m *ChannelAllowed) XXX_Size() int {
	return m.Size()
}
func (m *ChannelAllowed) XXX_DiscardUnknown() {
	xxx_messageInfo_ChannelAllowed.DiscardUnknown(m)
}

var xxx_messageInfo_ChannelAllowed proto.InternalMessageInfo

func (m *ChannelAllowed) GetChannel() string {
	if m != nil {
		return m.Channel
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ChannelAllowed)(nil), "aura.v1.ChannelAllowed")
}
...
var fileDescriptor_2e649e32a11ca0c4 = []byte{
	...
	,
}
...
func (m *ChannelAllowed) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ChannelAllowed) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ChannelAllowed) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ChannelAllowed) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ChannelAllowed) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ChannelAllowed: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ChannelAllowed: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
