...
const (
	...
	Query_BlockedChannels_FullMethodName = "/aura.v1.Query/BlockedChannels"
)
...
func (c *queryClient) Burners(ctx context.Context, in *QueryBurners, opts ...grpc.CallOption) (*QueryBurnersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Burners_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Minters(ctx context.Context, in *QueryMinters, opts ...grpc.CallOption) (*QueryMintersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Minters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Pausers(ctx context.Context, in *QueryPausers, opts ...grpc.CallOption) (*QueryPausersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Pausers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) BlockedChannels(ctx context.Context, in *QueryBlockedChannels, opts ...grpc.CallOption) (*QueryBlockedChannelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_BlockedChannels_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) BlockedChannels(context.Context, *QueryBlockedChannels) (*QueryBlockedChannelsResponse, error) {
...
func _Query_BlockedChannels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_BlockedChannels_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
